...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      {/* Hero */}
      <div className="relative text-center py-10 sm:py-14" style={{ animation: 'slide-up 400ms ease-out' }}>
        <div
        ...
        <div className="relative">
          <h1 className="text-3xl sm:text-4xl font-extrabold" style={{ color: 'var(--text-primary)' }}>
            Predicting How NBA{' '}
            <span style={{ color: '#FF6B35' }}>Injuries</span>{' '}
            Cascade Through Team Performance
          </h1>
      ...
      {gamesLoading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4">
            ...
            >
              <span className="w-1 h-4 rounded-full" style={{ backgroundColor: '#FF6B35' }} />
              Upcoming Games
            </h2>
            <GamesList
              games={games}
              ...
              <div className="space-y-5">
                ...
                {hasAbsences ? (
                  <>
                    ...
                    {/* Ripple chart */}
                    <div className="card card-body" style={{ animation: 'fade-in 400ms ease-out' }}>
                  ...
                  <div className="card card-body space-y-4">
                    ...
                    >
                      <Activity className="w-4 h-4 shrink-0" style={{ color: '#FF6B35' }} />
                      <span>
